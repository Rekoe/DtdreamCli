 ...
 */
public class GetBucketAcl extends Command implements CommandParser {
    private final String COMMAND_NAME = "getBucketAcl";
    ...
    public void help() {
        ...
        System.out.println("    getBucketAcl 查询指定 bucketName 的访问控制权限");
        System.out.println("SYNOPSIS");
        System.out.println("    getBucketAcl [options -b] ");
        System.out.println("DESCRIPTION");
        System.out.println("    --查询指定 bucketName 的访问控制权限");
    ...
    public boolean checkParameters() {
        if(StringUtils.isBlank(bucketName)){
            System.out.println("参数错误！bucketName 不能为空");
            CommandRecord.getInstance().popLastCommand();
            return false;
        }
        return true;
