 ...
 */
public class GetBucketLocation extends Command implements CommandParser {
    private final String COMMAND_NAME = "getBucketLocation";
    ...
    public void help() {
        ...
        System.out.println("    getBucketLocation 获取指定bucketName 的 Bucket Region");
        System.out.println("SYNOPSIS");
        System.out.println("    getBucketLocation [options -b] ");
        System.out.println("DESCRIPTION");
        System.out.println("    --获取指定bucketName 的 Bucket Region");
    ...
    public boolean checkParameters() {
        if(StringUtils.isBlank(bucketName)){
            System.out.println("参数错误，bucketName 不能为空，请输入：getBucketLocation -help 查询帮助。");
            CommandRecord.getInstance().popLastCommand();
            return false;
        }
        return true;
